...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        src_dict, tgt_dict, tgt_type_dict = task.source_dictionary, task.target_dictionary, task.target_type_dictionary
        ...
        decoder = cls.build_decoder(args, tgt_dict, tgt_type_dict, decoder_embed_tokens)
