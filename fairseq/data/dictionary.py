...
class Dictionary:
    ...
    def __init__(
        ...
        *,  # begin keyword-only arguments
        ...
        self.keyword_word, self.operator_word, self.var_word = keyword, operator, var
        self.symbols = []
        self.count = []
        self.indices = {}
    ...
    def keyword(self):
        return self.index(self.keyword_word)
    
    def operator(self):
        return self.index(self.operator_word)
    
    def variable(self):
        return self.index(self.var_word)
